        ...
        <form method="post" action="{{url('news')}}">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input id="news_title" type="text" class="form-control" name="news_title" required>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                    ...
                    <input id="news_description" type="text" class="form-control" name="news_description" required>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                    ...
                    <input id="news_link" type="url" class="form-control" name="news_link" pattern="https?://.+"
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input id="created_at" type="datetime-local" class="form-control" name="created_at" required>
                </div>
            </div>
            <div class="row">
